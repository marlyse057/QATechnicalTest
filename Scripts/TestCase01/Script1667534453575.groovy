...
WebUI.setText(findTestObject('Object Repository/Page_Home  Service NSW/input_Find locations_q'), 'apply for a number plate')

WebUI.click(findTestObject('Object Repository/Page_Home  Service NSW/button_apply for a number plate_SearchBar___292bdf'))
...
WebUI.click(findTestObject('Object Repository/Page_Find a Service NSW location  Service NSW/svg'))
